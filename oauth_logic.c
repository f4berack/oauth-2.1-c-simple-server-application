...
int authorize(
    ...
    if(!is_valid_response_type(response_type)){
        ...
        OAuthErrorResponse error_response = {error_code_to_string(OAUTH_ERROR_INVALID_REQUEST), 
        ...
        resp = MHD_create_response_from_buffer(strlen(msg) ,(void*) msg, MHD_RESPMEM_MUST_FREE);
